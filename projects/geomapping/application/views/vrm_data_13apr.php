	...
	<hr>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body p-10">
                                                      <div class="col-lg-4 col-md-12 col-sm-12 p-t-20">
                                <div class="col-xs-3 c-gray">
                                    <div class="text-center m-b-20">
                                        <i class="f-24 fa fa-check-square-o"></i>
                                    </div>
                                   
                                </div>
                                <div class="col-xs-3 c-gray">
                                    <div class="text-center m-b-20">
                                        <i class="f-24 fa fa-times c-red"></i>
                                    </div>
                                    </div>
                                <div class="col-xs-3 c-gray">
                                    <div class="text-center m-b-20">
                                        <i class="f-24 fa fa-external-link "></i>
                                    </div>
                                </div>
								<div class="col-xs-3 c-gray">
                                    <div class="text-center m-b-20">
                                        <i class="f-24 fa fa-trash-o c-red"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
