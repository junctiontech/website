        ...
        <div id="main-content">
		 <form id="form4" role="form" parsley-validate="" class="icon-validation" 
            ...
            <div class="page-title"> <i class="icon-custom-left"></i>
                <h3><?=(!empty($data_validate[0]->user_role))?$data_validate[0]->user_role:''?></h3>
            </div>
               <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <select readonly name="department" class="form-control" data-style="input-lg btn-default">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select readonly name="asset" class="form-control" data-style="input-lg btn-default">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select readonly name="govasset" class="form-control" data-style="input-lg btn-default">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select readonly name="pvtasset" class="form-control" data-style="input-lg btn-default">
                                      ...
                                      <hr>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input readonly name="establishment"   type="text" placeholder="Enter Year" value="<?=(!empty($data_validate[0]->establishment))?$data_validate[0]->establishment:''?>"/>
                                                </div>
                                            </div>   
                                        </div>
                                        ...
                                        <div class="row">       
                                            <div class="form-group col-md-12">
                                                ...
                                                <div class="input-icon right">
                                                    <i class="fa fa-calendar"></i>
                                                <input readonly name="construction"  value="<?=(!empty($data_validate[0]->construction))?$data_validate[0]->construction:''?>" type="text" placeholder="Enter Year" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
    										<div class="form-group col-md-12">
                                                ...
                                                <div class="input-icon right">
                                                    <input readonly name="scheme" value="<?=(!empty($data_validate[0]->scheme))?$data_validate[0]->scheme:''?>" type="text" parsley-minlength="3" class="form-control parsley-validated">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
    										<div class="form-group col-md-12">
                                                ...
                                                <div class="input-icon right">
                                                    <input readonly name="agency" value="<?=(!empty($data_validate[0]->agency))?$data_validate[0]->agency:''?>" type="text" parsley-minlength="3" class="form-control parsley-validated">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
    										<div class="form-group col-md-12">
                                                ...
                                                <div class="input-icon right">
                                                    <select readonly name="physical_status" class="form-control">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <div class="input-icon right">
                                                    <select readonly name="programme" class="form-control">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <div class="input-icon right ">
                                                    <input readonly name="mis_code" value="<?=(!empty($data_validate[0]->mis_code))?$data_validate[0]->mis_code:''?>" type="text" parsley-minlength="3" class="form-control parsley-validated" placeholder="http://">
                                                </div>
                                            </br>
                                                <div class="input-icon right ">
                                                    <input readonly name="mis_code_sec" value="<?=(!empty($data_validate[0]->mis_code_sec))?$data_validate[0]->mis_code_sec:''?>" type="text" parsley-minlength="3" class="form-control parsley-validated" placeholder="http://">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <div class="input-icon right">
                                                    <select readonly name="electrified" class="form-control">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <div class="input-icon right">
                                                    <select readonly name="is_residential" class="form-control">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <div class="input-icon right">
                                                    <select readonly name="is_pvt" class="form-control">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <div class="input-icon right">
                                                    <select readonly name="boundary_wall" class="form-control">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <div class="input-icon right">
                                                    <select readonly name="computer" class="form-control">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <div class="input-icon right">
                                                    <select readonly name="ict" class="form-control">
                                    ...
                                    <div class="col-md-12">
                                          ...
                                          <hr>
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <div class="input-icon right">
                                                    <input readonly name="other_attribtes" value="<?=(!empty($data_validate[0]->other_attribtes))?$data_validate[0]->other_attribtes:''?>" type="text" parsley-minlength="3" class="form-control parsley-validated">
                                       ...
                                       <!--     <div class="form-group">
                                                <button type="submit" value="submit" class="btn btn-danger" onclick="javascript:$('#form4').parsley('validate');">Validate</button>
