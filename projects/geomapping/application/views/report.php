                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="navbar-form navbar-right show-xs" role="search">
										...
										<?php $i=''; foreach ($data_report as $report){ $i++; ?>
                                            <tr>
                                               <!-- <td><?=$report->date?></td>-->
                                                ...
                                                <td><a href="<?=base_url();?>admin/view_report/<?=$report->add_report_id?>" ><button type="button"  class="btn btn-sm btn-danger"><i class="fa fa-file-o"></i> View</button></a></td>
