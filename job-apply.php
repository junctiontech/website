				...
				<p>Thank you for your interest in Junction Software Pvt.Ltd. Please provide the following information about your profile. We shall get in touch with you
					...
					<form class="contact-form validate" role="form" method="post" action="job_apply.php" enctype="multipart/form-data">
						...
						<div class="form-group">
							<input type="text" name="name" class="form-control" placeholder="Name:" name="min_field" data-validate="number,minlength[4]">
						</div>
						<div class="form-group">
							<input type="text" name="phone" class="form-control" placeholder="Mobile No:" name="min_field" data-validate="number,minlength[4]">
						</div>
							<div class="form-group">
							<input type="text" name="email" class="form-control" placeholder="E-mail:" name="email" data-validate="email">
						</div>
						
							<div class="form-group">
							<input type="text" name="employer" class="form-control" placeholder="Present Employer:" name="min_field" data-validate="number,minlength[4]">
						</div>
						<div class="form-group">
							<input type="text" name="designation" class="form-control" placeholder="Present Designation:" name="min_field" data-validate="number,minlength[4]">
						</div>
						<div class="form-group">
